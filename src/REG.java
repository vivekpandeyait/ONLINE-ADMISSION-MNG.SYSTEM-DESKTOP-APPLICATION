...
CONNECTION obj = new CONNECTION();
    ...
    private void initComponents() {
        ...
        t8 = new javax.swing.JComboBox<String>();
        ...
        jLabel7.setText("Add Student Information");
    ...
    private void jButton3MouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_jButton3MouseClicked
        try {
obj.thequery("insert into reg () values('"+t2.getText()+"' , '"+t8.getSelectedItem().toString()+"' , '"+t3.getText()+"' , '"+t4.getText()+"' , '"+t5.getText()+"' ,'"+t6.getSelectedItem().toString()+"')");
